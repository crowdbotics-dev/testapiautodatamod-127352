...
## Project Structure
    ...
    ├── testapiautodatamod_127352  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_127352`
...
2. Clone this repo and `cd testapiautodatamod_127352`
